...
import * as Capture from './SlideCapture';
...
//
// The order is the argument: here is the room, here is who is in it, here is
// what we know about them, here is how the evening works — and only then, what
// it costs. Packages before the audience would make it a rate card.
//
...
// second copy of it would be one more thing to update when a URL changes.
// ─────────────────────────────────────────────────────────────────────────

const SLIDES: Slide[] = [Title, Community, Audience, Capture, Format, Packages, Links];
